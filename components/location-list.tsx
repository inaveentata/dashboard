...
const data: Location[] = [
  ...
  },
  {
    id: "2",
    name: "Warehouse A",
    address: "456 Industrial Pkwy, Anytown, USA",
    geofenceRadius: 750,
  },
  {
    id: "3",
    name: "Construction Site B",
    address: "789 Build Rd, Anytown, USA",
    geofenceRadius: 1000,
  },
]
...
export const columns: ColumnDef<Location>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => <div>{row.getValue("geofenceRadius")}</div>,
  },
  {
    id: "actions",
    enableHiding: false,
      ...
      return (
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            ...
            <DropdownMenuSeparator />
            <DropdownMenuItem>View location details</DropdownMenuItem>
